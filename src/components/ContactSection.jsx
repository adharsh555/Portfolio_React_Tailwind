            ...
            <div className="space-y-6 md:space-y-8">
              ...
              <div className="space-y-4 md:space-y-6">
                {[
                  ...
                  <div key={item.label} className="flex items-start gap-4 group p-2 md:p-0 w-full lg:w-auto justify-center lg:justify-start">
                    ...
                    <div className="pt-1.5 md:pt-2 text-left">
                      <p className="text-[10px] md:text-xs font-bold text-primary uppercase tracking-widest leading-none mb-1">{item.label}</p>
                      {item.href ? (
